...
class BorealisRawacf(BorealisRawacfv0_4):
    ...
    unshared_fields = BorealisRawacfv0_4.unshared_fields
...
class BorealisBfiq(BorealisBfiqv0_4):
    ...
    unshared_fields = BorealisBfiqv0_4.unshared_fields
...
class BorealisAntennasIq(BorealisAntennasIqv0_4):
    ...
    unshared_fields = BorealisAntennasIqv0_4.unshared_fields
