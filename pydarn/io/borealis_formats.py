...
class BorealisRawacf():
    ...
    single_element_types = {
        ...
        # range gate separation (equivalent distance between samples)
        ...
        "freq": np.uint32,
        # C data type of the samples such as complex float.
...
class BorealisBfiq():
    ...
    array_dtypes = {
        ...
        # Samples that have been blanked during TR switching.
        "blanked_samples": np.uint32,
        # For pulse encoding phase, in desgrees offset. Contains one phase offset per pulse in pulses.
