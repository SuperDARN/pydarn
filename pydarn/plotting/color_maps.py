...
class PyDARNColormaps():
    ...
    PYDARN = mcol.LinearSegmentedColormap.from_list("pydarn",["midnightblue","darkblue", "mediumblue",
                                                              "rebeccapurple","purple","darkmagenta","mediumvioletred",
                                                              "crimson","red","orangered","darkorange","orange", "gold"])
